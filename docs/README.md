...
### 🟥 **2. 구매한 로또 수만큼 랜덤수(6자리숫자)를 뽑는다. (Set에 저장)**
### 🟥 **3. 겹치지않는 당첨번호(6자리숫자) 입력을 ,(쉽표)로 구문하여 받는다.** 
### 🟥 **4. 보너스번호를 당첨번호와 겹치지 않게 받음.**
### 🟥 **5. 당첨번호와 랜덤수를 전체 비교한다. (교집합 갯수찾음)**
### 🟥 **6. 사이즈가 5개인 것 중에 보너스번호를 가지고 있는것을 따로 걸러서 2등처리**
